...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('/SingleElectronFlatPt0p2To50/UpgFall13-POSTLS261_V2-v1/GEN-SIM')
)
...
process.FEVTDEBUGoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:SingleElectron_NoPU_DIGI_RAW.root'),
