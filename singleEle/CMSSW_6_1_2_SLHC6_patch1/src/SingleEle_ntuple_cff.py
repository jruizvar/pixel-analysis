...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('file:SingleEle_DIGI_RAW.root')
)
...
process.TFileService = cms.Service("TFileService", fileName = cms.string('SingleEle_PU140_ntuple.root') )
