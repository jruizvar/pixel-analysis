...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('file:MinBias_NoPU_DIGI_RAW.root')
)
...
process.TFileService = cms.Service("TFileService", fileName = cms.string('MinBias_NoPU_ntuple.root') )
